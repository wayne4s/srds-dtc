...
class Common {
    ...
    public static void runBatch(Mascot module, String inputPath, String delim) throws IOException {
    ...
    public static void writeOutputs(final Mascot module, final String outputPath, final int trialNum, final long duringTime) throws IOException {
