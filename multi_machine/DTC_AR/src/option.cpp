...
double Option::rate(0.3);
unsigned int Option::budget(1E05);
unsigned int Option::totalSpace(1E08);
...
static struct option long_options[] = {
    ...
    {"totalSpace", required_argument, 0, SIZE_SPACE},
    {"rate", required_argument, 0, SIZE_RATE},
...
void Option::print()
{
    ...
    cout << Option::inFileName << "\t" << Option::outPath << "\t"
         << "budget: " << Option::budget << "\t"
         << "tolerance: " << Option::tolerance << "\t"
         << "totalSpace: " << Option::totalSpace << "\t"
         << "rate: " << Option::rate << "\t"
         << "trial: " << Option::trial << endl;
