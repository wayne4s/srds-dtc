...
void run_exp(const char *input, const char *outPath, MPIIO &hIO, int workerNum, Method_t method, int memSize, int totalSpace, double rate, int repeat, int bufLen = 10000, double tolerance = 0.2);
